...
// The size of the object name stored in the object base class. Larger names will be truncated.
 ...
 #define FW_OBJ_NAME_MAX_SIZE                128  //!< Size of object name (if object names enabled). AC Limits to 80, truncation occurs above 80.
 #endif
#endif
...
#define FW_QUEUE_NAME_MAX_SIZE               128   //!< Max size of message queue name
#endif

// Specifies the size of the string holding the task name for active components and tasks
#ifndef FW_TASK_NAME_MAX_SIZE
#define FW_TASK_NAME_MAX_SIZE               128    //!< Max size of task name
#endif
...
#define FW_CMD_STRING_MAX_SIZE           128   //!< Max character size of command string arguments
#endif
...
#define FW_FIXED_LENGTH_STRING_SIZE   1024 //!< Character array size for the filepath character type
#endif
